...
(function () {
    ...
    function solved(out) {
        out.textContent = '✅ Good job, Detective!. That seems correct! Solving this has revealed a code in itself: ❌❌☑️❌. This might be useful for later, let\'s note this and move to the next section for now.';
