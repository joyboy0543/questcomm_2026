...
// Clearance
(function(){ var p6Locked=document.getElementById('p6locked'); var p6Open=document.getElementById('p6open'); var ok2=getLS('qc_p2_ok')==='1', ok3=getLS('qc_p3_ok')==='1', ok4=getLS('qc_p4_ok')==='1', ok5=getLS('qc_p5_ok')==='1'; var all=ok2&&ok3&&ok4&&ok5; if(all){ p6Locked.style.display='none'; p6Open.classList.remove('hidden'); setLS('qc_p6_unlocked','1'); } })();
