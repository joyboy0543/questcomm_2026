...
(function(){
  ...
  // Radio ticker (seconds shown, continuous scroll, no reset every second)
  ...
  function addRadioMessage(text){ var li=document.createElement('li'); li.className='radio-msg'; var ts=new Date().toLocaleTimeString([], {hour:'2-digit', minute:'2-digit', second:'2-digit'}); li.innerHTML='<span class="radio-time">'+ts+'</span><span class="radio-text">'+text+'</span>'; feedUl.appendChild(li); }
